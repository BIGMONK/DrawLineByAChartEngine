 ...
 */
package com.ut.vrautocycling.utils.drawchart.baseutils.chart;
...
import com.ut.vrautocycling.utils.drawchart.baseutils.renderer.BasicStroke;
import com.ut.vrautocycling.utils.drawchart.baseutils.renderer.DefaultRenderer;
import com.ut.vrautocycling.utils.drawchart.baseutils.renderer.SimpleSeriesRenderer;
...
import com.ut.vrautocycling.utils.drawchart.baseutils.util.MathHelper;
...
//                        clickableArea.add(null);
        ...
        System.out.println("LLLLLLLdrawBackground1  x" + x + "  width=" + width);
        drawBackground(mRenderer, canvas, x, y, width, margins[0], paint, true,
                mRenderer.getMarginsColor());
        System.out.println("LLLLLLLdrawBackground2  x" + x + "  width=" + width);
